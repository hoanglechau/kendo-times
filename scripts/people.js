...
// The code here was adapted and edited from the documentation of the "fullPage.js" JavaScript library in order to set up the fullscreen scrolling effect
...
const imageList = document.querySelectorAll('.people__image');
